var PostShow = React.createClass ({
  ...
  render: function(){
    ...
    if (this.state){
      ...
      commentBox = <CommentsBox likeCallbacks={[ApiActions.addUnlikeShow, ApiActions.addLikeShow]} liked={this.state.post.liked} caption={this.state.post.caption} username={this.state.post.user.username} postId={this.props.params.postId} comments={this.state.post.comments} callback={this.callback}/>;
    }
